...
const translations: Record<LanguageCode, Record<TranslationKey, string>> = {
  en: {
    ...
    'settings.connectedSaved': 'Connected to selected backend {version}. Configuration saved.',
  ...
  it: {
    ...
    'settings.connectedSaved': 'Connesso al backend selezionato {version}. Configurazione salvata.',
